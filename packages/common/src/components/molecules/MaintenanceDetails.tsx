...
export const MaintenanceDetails = (props: IProps): React.ReactElement => {
  ...
  useEffect(() => {
    if (
      ...
      formProps.values[maintenanceUnitKey] === -1
    ) {
  ...
  return (
    <View
      style={[
        styles.container,
        PlatformUtils.isWeb() && !isMobile && styles.containerWeb,
      ]}
    >
      <View style={styles.fieldContainer}>
        <FormTextInput
          ...
          maxLength={
            formProps.values.maintenanceAmount &&
            formProps.values.maintenanceAmount.includes(".")
              ? 13
              : 12
          }
          formProps={formProps}
